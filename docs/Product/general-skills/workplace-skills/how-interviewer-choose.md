...
![01](/static/img/product/general-skills/how-interviewer-choose_images/01.png)
...
不同的职级需要承担不同的工作职责，可以看下[ 产品运营的类型 ](/docs/Product/operations/career/types.md)。一般JD（Job Description）中会明确阐述当前岗位的职级，职级从专员/助理 -> 产品经理 -> 高级产品经理 -> 资深产品经理 -> 产品专家 -> 总监逐步上升，薪资待遇也随之上升。
...
![02](/static/img/product/general-skills/how-interviewer-choose_images/02.png)
